...
$Requete = "SELECT amount, time, type FROM stats WHERE service = '".$varService."' and type = '15min' AND time > DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 12 HOUR) ORDER BY time"; //table name
