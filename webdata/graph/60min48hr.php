...
$Requete = "SELECT amount, time, type FROM stats WHERE service = '".$varService."' and type = 'hourly' AND time > DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 48 HOUR) ORDER BY time"; //table name
